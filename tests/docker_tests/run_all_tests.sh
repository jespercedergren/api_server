...
#docker run -it -e test_env='docker' --network api_default --mount type=bind,src="$(pwd)/..",target=/tests test_base python3.7 -m pytest tests/integration_tests/api/test_api_read_dynamodb.py
